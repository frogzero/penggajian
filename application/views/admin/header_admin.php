<div id='cssmenu'>
  <ul>
   ...
   <li style="float: right"><a href='<?php echo site_url('home/akun_admin')?>'><span>Akun</span></a></li>
   <!-- <li style="float: right"><a href='<?php echo site_url('admin/data_admin')?>'><span>Admin</span></a></li> -->
</ul>
</div>
