...
<head>
  ...
  <title>Grup Penggajian</title>
    ...
    <script type="text/javascript" src="<?=base_url()?>assets/datatable/DataTables/media/js/jquery.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/datatable/DataTables/media/js/jquery.dataTables.js"></script>
